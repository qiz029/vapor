...
- **motion.doctor**: local; required inputs: none.
- **motion.credits**: remote viggle; user approval; required inputs: none.
- **motion.plan**: local; required inputs: kind, video, budgetUSD.
- **motion.submit**: remote viggle; user approval; required inputs: plan.
