...
- **captions.align**: local; required inputs: project, audio, alignment, audioAsset.
- **transcript.import**: local; required inputs: project, source, id, input, origin.
- **transcript.pack**: local; required inputs: project, transcripts.
- **transcript.scribe**: remote elevenlabs; user approval; required inputs: project, source, id.
