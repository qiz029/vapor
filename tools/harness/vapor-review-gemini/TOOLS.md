...
- **gemini.video-review**: remote gemini; user approval; required inputs: video, contract.
- **gemini.style-extract**: remote gemini; user approval; required inputs: video, title.
- **gemini.music-review**: remote gemini; user approval; required inputs: audio.
