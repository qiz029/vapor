...
- **editing.validate**: local; required inputs: project, edl.
- **editing.render**: local; required inputs: project, edl.
- **editing.view**: local; required inputs: project, asset, start, end.
- **video.finalize**: local; required inputs: project, picture, audio, alignment, pictureAsset, audioAsset.
- **video.import-timeline**: local; required inputs: timeline, audio, title.
