...
- **regression.run**: local; required inputs: none.
- **regression.compare**: local; required inputs: before, after.
- **regression.annotate**: user-confirmed evidence only; required inputs: report, annotations.
