...
- **music.options**: local; required inputs: none.
- **music.init**: local; required inputs: option.
- **music.generate.validate**: local; required inputs: plan.
- **music.generate**: remote fal-music; user approval; required inputs: plan.
