...
- **voice.doctor**: local; required inputs: none.
- **voice.list**: local; required inputs: none.
- **voice.add**: local; required inputs: name, source, transcript, sourceNote.
- **voice.speak**: local; required inputs: name, textFile.
- **voice.prepare-model**: remote huggingface; user approval; required inputs: none.
