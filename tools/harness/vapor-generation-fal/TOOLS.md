...
- **video.generate-minimax-h3.validate**: local; required inputs: plan.
- **video.generate-minimax-h3**: remote fal-video; user approval; required inputs: plan.
- **video.generate-seedance.validate**: local; required inputs: plan.
- **video.generate-seedance**: remote fal-video; user approval; required inputs: plan.
- **video.generate-seedance25.validate**: local; required inputs: plan.
- **video.generate-seedance25**: remote fal-video; user approval; required inputs: plan.
