...
- **audio.assemble**: local; required inputs: manifest.
- **audio.verify**: local; required inputs: video, expected.
- **audio.mux**: local; required inputs: video, expected.
- **audio.mix**: local; required inputs: project, manifest.
- **audio.check**: local; required inputs: audio.
