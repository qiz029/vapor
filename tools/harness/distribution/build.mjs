...
if(publishable&&!repository)throw new Error('Publishable builds require the public repository URL');
...
function build(folder,allowlist,extra){
 ...
 manifest.version=version;manifest.private=!publishable;if(publishable)manifest.publishConfig={access:'public',tag:'beta',registry:'https://registry.npmjs.org/'};manifest.license='MIT';manifest.keywords=['dsh-plugin','deepseek-harness','vapor','media'];
