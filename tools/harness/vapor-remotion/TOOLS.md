...
- **remotion.validate**: local; required inputs: manifest.
- **remotion.render**: local; required inputs: manifest.
- **remotion.still**: local; required inputs: manifest.
- **remotion.music-video**: local; required inputs: manifest.
- **remotion.kinetic-mv**: local; required inputs: manifest.
- **remotion.lyric-driven-mv**: local; required inputs: manifest.
- **remotion.editorial-mv**: local; required inputs: manifest.
- **remotion.chorus-editorial**: local; required inputs: manifest.
- **video.animatic**: local; required inputs: project, plan.
